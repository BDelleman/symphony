...
description:
  ...
  merge-landing when green; use when asked to land, merge, or shepherd a PR to
  completion while preserving commit history.
---
...
# Merge with merge commit to preserve branch history.
