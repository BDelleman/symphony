...
export function createProjectExecutionHistoryTables(context: PersistenceStoreContext): void {
  context.db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS history_token_model_fact (
      ...
      auxiliary_result_count INTEGER,
      effective_models TEXT,
      tool_counts TEXT,
      mcp_counts TEXT,
      missing_reason TEXT,
      reconciliation_delta TEXT,
      model_usage TEXT,
      nested_session_detected INTEGER,
      supervised_session_coverage TEXT,
